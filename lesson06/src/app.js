			...
			<div className="col-md-4">
				<div className="panel panel-default">
					...
					<div className="panel-body" id="order-detail-container">
						...
						<div className="row">
							<button onClick={this.onSubmitClick} className="btn btn-success">结账出单</button>
						</div>
					</div>
				</div>
			</div>
...
var OrderBox = React.createClass({
	...
	**/
	...
	render: function() {
		return (
			<div className="row">
				<OrderDetailContainer onSubmitClick={this.handleSubmitClick} onOrderDetailDelClick={this.handleOrderDetailDelClick} orderGoods={this.state.orderGoods} />
