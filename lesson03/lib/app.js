...
var GoodsContainer = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ className: "col-md-8" },
			React.createElement(CategoryList, { category: this.props.category }),
			React.createElement(FlagList, { flag: this.props.flag }),
			React.createElement(GoodsList, { goods: this.props.goods })
		);
	}
});
...
var CategoryList = React.createClass({
	...
	render: function () {
		var categoryNode = this.props.category.map(function (category) {
			return React.createElement(
				"span",
				{ key: category.id, className: "btn btn-lg btn-success" },
 ...
 **/
	render: function () {
		return React.createElement(
			...
			React.createElement(GoodsContainer, { goods: this.state.goods, category: this.state.category, flag: this.state.flag })
		);
	}
});
